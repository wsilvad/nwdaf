...
import (
	...
	"github.com/wsilvad/nwdaf/analyticsinfo"
	"github.com/wsilvad/nwdaf/datacollection"
	"github.com/wsilvad/nwdaf/eventssubscription"
	...
	"github.com/wsilvad/nwdaf/factory"
...
func (nwdaf *NWDAF) Start() {
	...
	// Calling Prometheus API
	datacollection.InitEventExposureSubscriberPrometheus(self)
